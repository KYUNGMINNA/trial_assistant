					...
					<form action="#" method="post">
						<div class="detail-wrap clearfix">
							<table
								...
								<!-- 반복문 필요 -->
								<tr>
									<td class="info">기관명</td>
									<td><input class="form-control" type="text" name="#"
										class="#" value="기관1" disabled></td>
									<td class="info">사업자 번호</td>
									<td><input class="form-control" type="text" name="#"
										class="#" value="0000-0000" disabled></td>
								</tr>
								<tr>
									<td class="info">지원 공고 이력</td>
									<td><input class="form-control" type="text" name="#"
										class="#" value="제 2차 [경매]감정인 모집 공고" disabled></td>
									<td class="info">기관 전화번호</td>
									<td><input class="form-control" type="text" name="#"
										class="#" value="02-1234-1234" disabled></td>
								</tr>
								<tr>
									<td class="info">조력자 유형</td>
									<td><input class="form-control" type="text" name="#"
										class="#" value="경매" disabled></td>
									<td class="info">직업</td>
									<td><input class="form-control" type="text" name="#"
										class="#" value="부동산 컨설턴트" disabled></td>
								</tr>
								<tr>
									<td class="info">기관 팩스 번호</td>
									<td><input class="form-control" type="text" name="#"
										class="#" value="0000-0000" disabled></td>
									<td class="info">활동 가능 지역</td>
									<td><input class="form-control" type="text" name="#"
										class="#" value="서울" disabled></td>
								</tr>
								<tr>
									<td class="info">기본주소</td>
									<td><input class="form-control" type="text" name="#"
										class="#" value="서울시 강남구" disabled></td>
									<td class="info">지정 법원</td>
									<td><input class="form-control" type="text" name="#"
										class="#" value="서울서부지방법원" disabled></td>
								</tr>
								<tr>
									<td class="info">상세주소</td>
									<td><input class="form-control" type="text" name="#"
										class="#" value="테헤란로 13길 503호" disabled></td>
									<td class="info">기관 증빙 서류</td>
