    ...
    <div class="board_wrap">
        ...
        <div class="board_write_wrap">
            <div class="board_write">
                <div class="title">
                    <dl>
                        <dt>수정할 제목</dt>
                        <dd><input type="text" placeholder="수정할 제목 입력"></dd>
                    </dl>
                </div>
                <div class="info">
                <dl>
                ...
                <div class="cont"> 
                    ...
                    <textarea placeholder="수정할 내용 입력"></textarea>
                </div>
                ...
                data-toggle ="modal"  href="#myModal1"> 수정 완료</button>
            </div>
        ...
        <div class="modal" id="myModal1">
          <div class="modal-dialog modal-sm">
             ...
             <%--      <a data-toggle="modal" href="#myModal2" class="btn btn-primary">확인</a> --%>
                </div>
              </div>
            </div>
        </div>
